...
I'm currently sharpening my **Rust** backend skills while building production-grade portfolio projects such as **ArcaneForge**, to do list fantasy RPG web app ⚔️ built with React & Tailwind.  
At the same time, I'm working as a **Fullstack Developer Intern**, building real-world web systems across backend (API, MSSQL, CI4) and frontend (UI/UX, dashboards).
